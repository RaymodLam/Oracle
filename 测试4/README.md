...
### 解锁自己用户的权限
这里我直接用Oracle SQL Developer的图形界面更改的用户权限。

## 截图如下：
![](https://github.com/RaymodLam/Oracle/blob/master/test1/4_1.png?raw=true)

### 删除表（同时删除主外键、触发器和程序包）和序列
...
```
### 创建新表（Table DEPARTMENTS AND Table EMPLOYEES）
...
![](https://github.com/RaymodLam/Oracle/blob/master/test1/4-2.png?raw=true)

### 采用递归来查询某个员工及其所有下属以及子下属员工
...
![](https://github.com/RaymodLam/Oracle/blob/master/test1/4-3.png?raw=true)
...
![](https://github.com/RaymodLam/Oracle/blob/master/test1/4-4.png?raw=true)
